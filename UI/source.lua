-- I didnt make this I only edit it. eXo/slixx made it shout out to him! eXo#1763
...
TabBG.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
...
Inliner.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
...
function lib:NewTab(name, desc)
	...
	TabButton.BackgroundColor3 = #lib.Tabs == 0 and Color3.fromRGB(45,45,45) or Color3.fromRGB(35,35,35) -- SELECTED: Color3.fromRGB(231, 231, 255)
	...
	TabTitle.Text = name
	TabTitle.TextColor3 = #lib.Tabs == 0 and Color3.fromRGB(0, 190,255) or Color3.fromRGB(70,70,70) -- SELECTED: Color3.fromRGB(0, 190,255)
	TabTitle.TextSize = 14.000
	TabTitle.TextStrokeColor3 = Color3.fromRGB(0, 190,255)
	...
	TabButton.MouseButton1Click:Connect(function()
		if not lib.SelectedTab or lib.SelectedTab.button ~= tabtable.button then
			...
			lib.SelectedTab.TitleInstance.TextColor3 = Color3.fromRGB(0, 190,255)
		end
	end)
	...
	function tabFuncs:NewToggle(name, default, callback)
		...
		if not togglefuncs.enabled then
			...
			Checkbox.BackgroundColor3 = Color3.fromRGB(0, 190,255)
			UIStroke.Color = Color3.fromRGB(72,74,76)
		end
		...
		Toggle.MouseButton1Click:Connect(function()
			if togglefuncs.enabled then
				...
				game:GetService("TweenService"):Create(Checkbox,TweenInfo.new(0.15),{BackgroundColor3 = Color3.fromRGB(0, 190,255)},"InOut","Sine"):Play()
				game:GetService("TweenService"):Create(UIStroke,TweenInfo.new(0.15),{Color = Color3.fromRGB(60,60,60)},"InOut","Sine"):Play()
